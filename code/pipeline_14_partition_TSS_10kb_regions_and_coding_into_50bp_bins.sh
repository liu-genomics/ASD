...
bedtools makewindows -b ../other_annotation/epigenomic_annotation/Whole_genome.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed.temp2 -w 50 |awk {'print $1"\t"$2"\t"$3"\tnf"NR'} > ../other_annotation/epigenomic_annotation/Whole_genome.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed.50bp_window.bed
...
bedtools makewindows -b ../other_annotation/epigenomic_annotation/Whole_genome.promoter_1kb_genename.bed.temp2 -w 50 |awk {'print $1"\t"$2"\t"$3"\tpromoter"NR'} > ../other_annotation/epigenomic_annotation/Whole_genome.promoter_1kb_genename.bed.50bp_window.bed
