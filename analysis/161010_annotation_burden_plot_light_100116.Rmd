...
```{r}
# draw rectangular functio is disabled for now (geom_rect). 
library(ggplot2)
mydata <- "../data/0703_region_list_100116_burden_scanning_light.Rdata"
```
...
```{r plot_noonan_roadmap, fig.width=8, fig.height=6, echo=FALSE}
...
```{r plot_dhs, fig.width=10, fig.height=8, echo=FALSE}
