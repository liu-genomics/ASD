...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Noonan_brain_union", "GERP", "NP_genes")$graph
```
...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Encode_DHS_union", "GERP", "NP_genes")$graph
```
...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Noonan_brain_union", "CADD", "NP_genes")$graph
...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Encode_DHS_union", "CADD", "NP_genes")$graph
```
...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Noonan_brain_union", "GERP", "all_genes")$graph
```
...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Encode_DHS_union", "GERP", "all_genes")$graph
```
...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Noonan_brain_union", "CADD", "all_genes")$graph
...
burden_trend_for_each_epi_data("0703_data_for_analysis.bed", "../other_annotation/epigenomic_annotation/", "Encode_DHS_union", "CADD", "all_genes")$graph
```