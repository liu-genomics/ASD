...
temp1 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Noonan_brain_union", "Promoter+20kb_enhancer","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Noonan_brain_union", "Promoter+20kb_enhancer","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Noonan_brain_union", "Promoter+20kb_enhancer","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Noonan_brain_union", "Promoter+20kb_enhancer","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
temp1 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Brain_roadmap", "Promoter+20kb_enhancer","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Brain_roadmap", "Promoter+20kb_enhancer","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Brain_roadmap", "Promoter+20kb_enhancer","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Brain_roadmap", "Promoter+20kb_enhancer","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
temp1 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Noonan_roadmap_union", "Promoter+20kb_enhancer","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Noonan_roadmap_union", "Promoter+20kb_enhancer","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Noonan_roadmap_union", "Promoter+20kb_enhancer","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset(temp,input_type = "table",ref = "self", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Noonan_roadmap_union", "Promoter+20kb_enhancer","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
plot_summary = plot_summary[plot_summary$region_tag == "Promoter+20kb_enhancer" | plot_summary$region_tag == "Promoter" | plot_summary$region_tag == "1-10Kb" | plot_summary$region_tag == "10-20Kb",]
plot_summary$gene_list = factor(plot_summary$gene_list, levels = c("stringent_ASD", "ID_genes", "SCZ_composite","NP_genes","total"))
