...
> ##### Now start to identify new genes from the base-level model
...
##### cacluate the bayes factor table for splicing mutations. The mutation rate needs to be adjusted after taking into consideration of windows from introns far from TSSs
