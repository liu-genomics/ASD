...
mutation = new.env()
load("../data/161026_Filtered_Stephen_Scherer_Gemomic_Medicine_ASD_de_novo_SNVs_germline_with_258_control_data_matrixtransformed_for_old_code.Rdata", envir = mutation)
write.table(mutation$mutation[,1:4],"161026_filtered_stephen_scherer_data_using_258_control.bed",col.names = FALSE, row.names = FALSE, sep = "\t", quote = FALSE)
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Whole_genome.promoter_1kb_genename.bed")

temp1 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = stringent_ASD)
...
temp2 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = ID_genes)
...
temp3 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = SCZ_composite)
...
temp4 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = relaxed_ASD)
...
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Whole_genome.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed")
temp2 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Whole_genome.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
temp3 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Whole_genome.promoter_1kb_genename.bed")
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Whole_genome.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
...
Noonan enhancers
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_union.promoter_1kb_genename.bed")
...
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_union.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed")
temp2 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
temp3 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_union.promoter_1kb_genename.bed")
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
...
Fantom fetal brain
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Fantom_fetal_brain_500bp_union.promoter_1kb_genename.bed")

temp1 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Fantom", "Promoter","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Fantom", "Promoter","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Fantom", "Promoter","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Fantom", "Promoter","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Fantom_fetal_brain_500bp_union.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed")
temp2 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Fantom_fetal_brain_500bp_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
temp3 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Fantom_fetal_brain_500bp_union.promoter_1kb_genename.bed")

temp = do.call("rbind",list(temp,temp2,temp3))
temp = temp[!duplicated(temp),]

temp1 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Fantom", "Promoter+enhancer","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Fantom", "Promoter+enhancer","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Fantom", "Promoter+enhancer","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Fantom", "Promoter+enhancer","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
temp1 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Fantom", "Promoter+10kb_enhancer","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Fantom", "Promoter+10kb_enhancer","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Fantom", "Promoter+10kb_enhancer","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Fantom", "Promoter+10kb_enhancer","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
temp1 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Fantom", "1-10Kb","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Fantom", "1-10Kb","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Fantom", "1-10Kb","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Fantom", "1-10Kb","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Fantom_fetal_brain_500bp_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")

temp1 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = stringent_ASD)
temp1 = data.frame(lapply(translate_to_plotting_v2(temp1, "Fantom", "10-20Kb","stringent_ASD"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp2 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = ID_genes)
temp2 = data.frame(lapply(translate_to_plotting_v2(temp2, "Fantom", "10-20Kb","ID_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp3 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = SCZ_composite)
temp3 = data.frame(lapply(translate_to_plotting_v2(temp3, "Fantom", "10-20Kb","SCZ_composite"), function(y) if(is.numeric(y)) round(y, 3) else y)) 

temp4 = show_burden_for_selected_features_with_geneset_CG_corrected(temp,input_type = "table",ref = "total_ratio", geneset = relaxed_ASD)
temp4 = data.frame(lapply(translate_to_plotting_v2(temp4, "Fantom", "10-20Kb","NP_genes"), function(y) if(is.numeric(y)) round(y, 3) else y)) 
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Brain_roadmap_union.promoter_1kb_genename.bed")
...
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Brain_roadmap_union.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed")
temp2 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Brain_roadmap_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
temp3 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Brain_roadmap_union.promoter_1kb_genename.bed")
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Brain_roadmap_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_roadmap_union.promoter_1kb_genename.bed")
...
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_roadmap_union.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed")
temp2 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_roadmap_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
temp3 = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_roadmap_union.promoter_1kb_genename.bed")
...
```{r,echo=FALSE}
temp = generate_mut_enhancer_pair_for_burden_analysis("161026_filtered_stephen_scherer_data_using_258_control.bed","../other_annotation/epigenomic_annotation/Noonan_brain_roadmap_union.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed")
...
for(sc in unique(plot_summary$score)){
        ...
        for(i in unique(sub_sum$cutoff)){
                ...
                p <- ggplot(sub_sum_tmp) + geom_tile(aes(x = as.factor(bed), y = as.factor(region_tag), fill = burden)) + scale_fill_gradient2(midpoint = 1, na.value = 'black', limits = c(0, 2))
