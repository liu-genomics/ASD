...
report_proportion = 0.005
mutrate_ref_file = "../other_annotation/mutation_rate/Daly_mutrate.bw" 
node_n =6
feature_start = 5
feature_end = 9
feature_number = 5
...
# sample_size is encoded from [adjust_mutation_rate_window_to_base_compact_more_feature_splicing_hybrid]
estimate_effect_size_for_simulation_data_mixture_with_categorization_for_compact_data_splicing_hybrid<-function(data, splicing_data, non_splicing_features , gene_prior_file){
