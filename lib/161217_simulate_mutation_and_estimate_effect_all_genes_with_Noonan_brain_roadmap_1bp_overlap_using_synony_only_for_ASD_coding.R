...
# use all genes by posterior probability of being risk genes from high to low. 
...
save.image("../analysis/161217_simulate_mutation_and_estimate_effect_all_genes_with_Noonan_brain_roadmap_union_1bp_overlap_using_synony_only_for_ASD_coding.Rdata")
quit("no",0)
