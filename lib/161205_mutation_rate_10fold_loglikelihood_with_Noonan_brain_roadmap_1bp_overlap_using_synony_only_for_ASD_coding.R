...
control_model_258 = run_glm_for_mutation("./temp.bed", "../other_annotation/epigenomic_annotation/Whole_genome.promoter_yanyu_10kb_exons_no_utr_no_na_genes.50bp_window.bed",
                                         ...
                                         "no.txt")
control_model_258_loglikelihood = get_10fold_log_likelihood(control_model_258, 10, 258)
...
control_model_693 = run_glm_for_mutation("./temp.bed", "../other_annotation/epigenomic_annotation/Whole_genome.promoter_yanyu_10kb_exons_no_utr_no_na_genes.50bp_window.bed",
                                         ...
                                         "/media/yuwen/Elements/ANNOVAR/annovar/",
                                         "annovar_input_temp.bed")
control_model_693_loglikelihood = get_10fold_log_likelihood(control_model_693, 10, 693)
...
ASD_model_Scherer = run_glm_for_mutation("./temp.bed", "../other_annotation/epigenomic_annotation/Whole_genome.promoter_yanyu_10kb_exons_no_utr_no_na_genes.50bp_window.bed",
                                         ...
                                         "/media/yuwen/Elements/ANNOVAR/annovar/",
                                         "annovar_input_temp.bed")
ASD_model_Scherer_loglikelihood = get_10fold_log_likelihood(ASD_model_Scherer, 10, 200)
rm(ASD_model_Scherer)
rm(scherer_case)
system("rm annovar_input_temp.bed")
system("rm temp.bed")

save.image("../analysis/161205_mutation_rate_10fold_likelihood_with_Noonan_brain_roadmap_union_1bp_overlap_using_synony_only_for_ASD_coding.Rdata")
quit("no",0)
