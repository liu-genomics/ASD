...
# lower the effect size of active promoters and active enhancers to 3 and 2, respectively. 
...
save.image("../analysis/161215_simulate_mutation_and_estimate_effect_top6_pct_with_Noonan_brain_roadmap_union_1bp_overlap_using_synony_only_for_ASD_coding.Rdata")
quit("no",0)
