# modified from yanyu's code in CRI. Her code works for Python 2.5. 
# My code here works only for Python >3
...
if sys.argv[1] == '--help':
	print('query_tabix.py [input_tabix.in] [TAB_file] [header_file]')
	sys.exit()
