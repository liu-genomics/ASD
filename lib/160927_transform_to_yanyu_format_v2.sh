...
# sh 160927_transform_to_yanyu_format_v2.sh [epigenomic_prefix] [reference] [epigenomic_folder] [transform_flag]
...
# The difference between 160927_transform_to_yanyu_format_v2.sh and 160927_transform_to_yanyu_format.sh is the way how enhancers are partitioned. 
#enhancers used for this code are partitioned by pipeline_03 in ../code. So the partition is exactly the same as Yanyu's pipeline, but gene-enhancer assignemnt is fixed. 
...
Rscript ../lib/transform_bed_regions_to_yanyu_format.R $reference ${epigenomic_folder} ${epigenomic_prefix}.yanyu_pipeline_enhancers.10000.bp_within_TSS.bed ${epigenomic_prefix}_yanyu_format_${transform_flag} 1 rest_intersect__0__10000__ ${output_postfix}
Rscript ../lib/transform_bed_regions_to_yanyu_format.R $reference ${epigenomic_folder} ${epigenomic_prefix}.yanyu_pipeline_enhancers.10000_to_20000.bp_within_TSS.bed ${epigenomic_prefix}_yanyu_format_${transform_flag} 1 rest_intersect__10000__20000__ ${output_postfix}
